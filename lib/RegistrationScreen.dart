            ...
            children: [
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor:
                      Colors.black, // Button color changed to black
            ...
            child: Row(
              ...
              children: [
                Card(
                  ...
                  color: Colors.black, // Change card background color to black
                  child: InkWell(
                    onTap: () {
                      _imgFromGallery();
                    },
...
class FacePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Paint p = Paint();
    p.color = Colors.green; // Change the face bounding box color
